...
**Repositório de Backend**: <https://github.com/PvitorDev/back-integral-m05-t07>

**Repositório de Frontend**:  <https://github.com/PvitorDev/front-integral-m05-t07>

**URL da aplicação funcionando**: <https://desafio-cubos-front.netlify.app/>
