...
export default function TablePaid({ paidCharges }) {

    const navigate = useNavigate();

    function handlePage() {
        removeLocalItem('currentPage')
        setLocalItem('currentPage', 'pagas')
        navigate('/charges')
    }

    return (
        <TableContainer className='container-table-paid' component={Paper}
            sx={{
                borderRadius: '20px',
                maxWidth: '360px',
            }}>
                ...
                <TableHead>
                    <TableRow >
                        ...
                        <TableCell align="center" colSpan={3}>
                            <h3 className='paidTotals'>{paidCharges.length}</h3>
                        </TableCell>
                    </TableRow>
                    <TableRow>
